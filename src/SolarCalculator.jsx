...
const STATES = ["AL","AK","AZ","AR","CA","CO","CT","DE","DC","FL","GA","HI","ID","IL","IN","IA","KS","KY","LA","ME","MD","MA","MI","MN","MS","MO","MT","NE","NV","NH","NJ","NM","NY","NC","ND","OH","OK","OR","PA","RI","SC","SD","TN","TX","UT","VT","VA","WA","WV","WI","WY","Other"];
...
const EXPORT_RATE = 0.08;      // $/kWh for exported surplus
const BATT_EFF = 0.90;         // round-trip efficiency
const BATT_UTIL = 0.80;        // avg daily cycling utilization
const SOLAR_HOUR_SHARE = 0.45; // share of home usage during solar hours
const BATT_COST_KWH = 1000;    // installed $/kWh before ITC
const BATT_KW_PER_KWH = 0.5;   // approx continuous inverter output per kWh of storage
const EV_MI_PER_KWH = 3.5;     // typical EV efficiency
